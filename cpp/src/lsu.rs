unsafe extern "C" {
    ...
    pub fn vlsu_set_data_r(dut: *mut std::ffi::c_void, val: u32);
    ...
    pub fn vlsu_get_data_addr(dut: *mut std::ffi::c_void) -> u32;
    pub fn vlsu_get_data_w(dut: *mut std::ffi::c_void) -> u32;
