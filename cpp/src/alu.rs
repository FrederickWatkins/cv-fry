...
unsafe extern "C" {
    ...
    pub fn valu_set_operand_1(dut: *mut std::ffi::c_void, val: u32);
    pub fn valu_set_operand_2(dut: *mut std::ffi::c_void, val: u32);
    pub fn valu_get_result(dut: *mut std::ffi::c_void) -> u32;
}