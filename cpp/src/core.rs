unsafe extern "C" {
    ...
    pub fn vcore_set_data_r(dut: *mut std::ffi::c_void, val: u64);

    // Outputs to Memory/Peripherals
    pub fn vcore_get_instr_re(dut: *mut std::ffi::c_void) -> u8;
    pub fn vcore_get_instr_addr(dut: *mut std::ffi::c_void) -> u64;
    pub fn vcore_get_instr_sel(dut: *mut std::ffi::c_void) -> u8;
    pub fn vcore_get_data_re(dut: *mut std::ffi::c_void) -> u8;
    pub fn vcore_get_data_addr(dut: *mut std::ffi::c_void) -> u64;
    pub fn vcore_get_data_sel(dut: *mut std::ffi::c_void) -> u8;
    pub fn vcore_get_data_we(dut: *mut std::ffi::c_void) -> u8;
    pub fn vcore_get_atomic(dut: *mut std::ffi::c_void) -> u8;
    pub fn vcore_get_amo_op(dut: *mut std::ffi::c_void) -> u8;
    pub fn vcore_get_data_w(dut: *mut std::ffi::c_void) -> u64;
