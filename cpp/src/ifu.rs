...
unsafe extern "C" {
    ...
    pub fn vifu_set_ja(dut: *mut std::ffi::c_void, val: u64);
    ...
    pub fn vifu_get_curr_pc(dut: *mut std::ffi::c_void) -> u64;
    pub fn vifu_get_inc_pc(dut: *mut std::ffi::c_void) -> u64;
    pub fn vifu_get_addr(dut: *mut std::ffi::c_void) -> u64;
